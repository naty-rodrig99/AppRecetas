...
import static com.example.apprecetas.View.MenuActivity.convertidorArrays;

public class SearchActivity extends AppCompatActivity {
    RadioButton nombre,tipo,ingrediente;
    EditText eBuscar;
    public static ArrayList<MenuActivity.Receta> resultado = new ArrayList<>();
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        String nom ="";
                        String type="";
                        MenuActivity.Receta recipe=new MenuActivity.Receta();
                        while(cont< j.length()) {
                            ...
                            if(tipo =="ingrediente") {
                                recipe = new MenuActivity.Receta(nom, ing, type, steps, img);
                                System.out.println(recipe);
                            }
                            if(tipo == "nombre" ) {
                                recipe = new MenuActivity.Receta(nombre, ing, type, steps, img);

                            }
                            if(tipo == "tipo" ) {
                                recipe = new MenuActivity.Receta(nom, ing, tipo, steps, img);
